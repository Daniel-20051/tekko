...
export const BackgroundBeams = React.memo(
  ({ className }: { className?: string }) => {
    ...
    const primaryColor = isDark ? '#8a4a42' : '#743a34'
    const secondaryColor = isDark ? '#a55a50' : '#5a2d28'
    const basePathColor = isDark ? '#ffffff' : '#743a34'
    ...
    return (
      <div
        className={cn(
          "absolute inset-0 flex h-full w-full items-center justify-center mask-no-repeat mask-size-[50px]",
          className,
        )}
      >
        <svg
        ...
        >
          ...
          {paths.map((path, index) => (
            <motion.path
              ...
              strokeOpacity={animatedPathOpacity}
              strokeWidth={strokeWidth}
            ></motion.path>
          ))}
          <defs>
