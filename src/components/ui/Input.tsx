        ...
        <div className="relative">
          ...
          {isPassword && (
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors z-10"
              tabIndex={-1}
